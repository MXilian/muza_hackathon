...
scripts/
- Основа функционала бота (код для обработки логики бота, функции для взаимодействия с пользователям, обработки команд и сообщений, а также интеграции с API) bot_handler.py
