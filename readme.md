...
|----|----|----|
|/start|Инициализирует взаимодействие с ботом. При первом запуске бот может приветствовать пользователя и объяснять, какие функции доступны
|Отправляет приветственное сообщение и основные инструкции|
---
