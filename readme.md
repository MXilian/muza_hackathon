...
Описание: Позволяет пользователю выбрать интересы, которые будут использоваться для дальнейших рекомендаций.
Функционал: Предоставляет список доступных интересов и позволяет пользователю выбрать один или несколько из них.
/remove_interest
