    ...
    def generate_museum_descriptions(self, museums: List[Dict[str, Any]]) -> str:
        ...
        for museum in museums:
            ...
            prompt = (
                ...
                "Допустимый размер описания: до 350 символов. Основной упор - не на описании, а на соответствии моим интересам - "
                "его нужно всячески подчеркивать."
            )

            # Отправляем запрос в Mistral
            response = self.mistral_connector.generate_text(prompt, temperature = 1.3)
