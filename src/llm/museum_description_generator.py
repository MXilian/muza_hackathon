    ...
    def generate_museum_descriptions(self, museums: List[Dict[str, Any]]) -> str:
        ...
        for museum in museums:
            ...
            prompt = (
                ...
                "созданный специально для ценителей традиционной культуры: здесь представлены народные костюмы, "
                ...
                "Допустимый размер описания: до 350 символов. Основной упор - не на описании, а на том, "
                "почему он может меня заинтересовать. "
            )
